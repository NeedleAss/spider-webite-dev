...
export const parts = [
 ...
 {id:'servo',name:'舵机',en:'ACTUATION',category:'行动 / ACTUATION',description:'驱动轮组，把主控输出转为机械运动。实际中位、方向与死区必须通过架空校准和现场验证确定。',principle:'校准后，才允许驱动',detail:'目标装配呈现四个舵机；第四个沿用源装配保存的隐藏实例矩阵，实际安装待现场核对。',offset:[0,-35,0]},
 ...
 {id:'shell',name:'外骨骼',en:'ENCLOSURE',category:'结构 / ENCLOSURE',description:'为内部模块提供外部支撑与保护。拆解后可以观察内部部件的相对布置。',principle:'结构为功能留出空间',detail:'白色打印外观参考团队照片，结构几何与安装位置来自源文件。',offset:[125,30,0]},
 {id:'lid',name:'顶盖',en:'TOP COVER',category:'结构 / TOP COVER',description:'完成顶部覆盖，与屏幕及内部模块的布置共同构成整机外形。',principle:'从完整外观到内部结构',detail:'顶盖与顶部 OLED 一起抬升；退出自由探索返回原章节。',offset:[0,80,0]},
 ...
 {id:'camera-mount',name:'摄像头架',en:'VISION MOUNT',category:'结构 / VISION MOUNT',description:'固定相机位置与朝向。相机安装会影响观察范围与跟随时的画面解释。',principle:'观察从安装开始',detail:'视域示意绑定镜头安装方向，不是相机光学标定结果。',offset:[-65,25,85]},
 {id:'board-frame',name:'主板外骨骼',en:'FRAME',category:'结构 / FRAME',description:'支撑内部电子模块，连接板件与外部机身。通过展开可查看内部结构的层次。',principle:'为模块安排位置',detail:'结构沿用源装配变换；目标装配与原始记录的差异在资产清单中记录。',offset:[65,25,-25]},
];
