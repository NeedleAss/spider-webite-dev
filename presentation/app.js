...
function fallback(message){$('poster').hidden=false;$('loadStatus').hidden=false;$('loadStatus').replaceChildren(document.createTextNode(message+' '));const link=document.createElement('a');link.href='assets/film-v7/CareRover-film.mp4';link.textContent='播放离线影片 ↗';$('loadStatus').append(link);$('inspect').disabled=true;document.body.dataset.viewer='fallback';}
