async page=>{
 ...
 await page.mouse.move(1000,400);await page.waitForTimeout(1100);await page.mouse.move(140,35);await page.waitForFunction(()=>window.__careRover.snapshot().open<.001,{},{timeout:3500});check('unselected exit collapses after delay',(await page.evaluate(()=>window.__careRover.snapshot())).open<.001);
