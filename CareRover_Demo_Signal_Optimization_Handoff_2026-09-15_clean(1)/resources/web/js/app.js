...
function render() {
  ...
  text('gestureDetail', gestureStale ? '—' : `${g.stable && g.confidence >= CONFIG.GESTURE_STABLE_CONFIDENCE ? tr('已稳定', 'Stable') : tr('待确认', 'Unconfirmed')} · ${value((Date.now() - state.vision.lastGestureTs) / 1000, 1, ' s')}`);
