...
这是已有集成源码，不是空白项目。开始工作先读 `WINDOWS_START_HERE.md`、`docs/WINDOWS_ULTRASONIC_HANDOFF.md`，再读 `docs/tracking-development.md`、`docs/ultrasonic-development.md` 和对应验收记录。`docs/WINDOWS_AI_HANDOFF.md` 是早期改动索引，其历史未提交状态不代表当前 Git。本文件适用于此工程；原始参考目录保持不变。
